...
local ESCEnable             = true

local Speed                 = 1
local MaxSpeed              = 16.0

local MOVE_FORWARDS         = 32
local MOVE_BACKWARDS        = 33
local MOVE_LEFT             = 34
local MOVE_RIGHT            = 35
local MOVE_UP               = 44
local MOVE_DOWN             = 46

local SPEED_DECREASE        = 14
local SPEED_INCREASE        = 15
local SPEED_RESET           = 348
local SPEED_SLOW_MODIFIER   = 36
local SPEED_FAST_MODIFIER   = 21
local SPEED_FASTER_MODIFIER = 19
...
local RunNoClipThread = function()
...
local ToggleNoClip = function(state)
    ...
    -- Use TriggerEvent to show notification, se quiser, ou adaptar para o seu sistema de notificações
    TriggerEvent("chat:addMessage", {
        args = { "NoClip", IsNoClipping and "NoClip ativado." or "NoClip desativado." }
    })
...
RegisterNetEvent("creative-admin:toggleNoClip")
AddEventHandler("creative-admin:toggleNoClip", function()
